...
type Props = NativeStackScreenProps<ChatStackParamsList, "chat_member_id">;
...
export default function ChatMemberID({ navigation, route }: Props) {
  ...
  const fetchMessagesRoom = async () => {
    ...
    try {
      const res = await fetch(
        `${process.env.EXPO_PUBLIC_BASE_API_URL}/api/message?userId=${user?.id}&roomId=${roomId}`,
        {
          method: "GET",
          headers: {
